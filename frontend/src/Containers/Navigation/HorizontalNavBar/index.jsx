...
import logoPNGImage from "../../../assets/images/ToxiCheck-logo.png";
  ...
  return (
    <nav className="navbar">
      {/* <Link to="/" className="link">
        <img src={logoPNGImage} alt="ToxiCheck Logo" className="logo-icon" />
        ToxiCheck
      </Link> */}
      ...
      <div className="login-button-mobile-hidden">
        <div className="icons">
          <a
            href="https://github.com/JackyChung2003/CPT316-G29-Assignment-2"
            target="_blank"
            rel="noreferrer"
          >
            <svg
